...
MAIN_SRC="src/main.c src/txt_editor_state.c src/txt_editor_func.c src/txt_editor_draw.c src/txt_editor_file.c src/json_read.c src/error_log.c src/lsp_src/language_server_communication.c"
